...
On this page you can find a gallery of all built-in themes. 
These themes can also provide a good starting point for [creating a custom theme](docs/tutorials/styling-and-themes#creating-a-custom-preset-or-theme). 
